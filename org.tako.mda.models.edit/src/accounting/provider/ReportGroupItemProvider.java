...
/**
 * This is the item provider adapter for a {@link accounting.ReportGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReportGroupItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReportGroup_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReportGroup_name_feature", "_UI_ReportGroup_type"),
				 AccountingPackage.Literals.REPORT_GROUP__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAccountPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReportGroup_account_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReportGroup_account_feature", "_UI_ReportGroup_type"),
				 AccountingPackage.Literals.REPORT_GROUP__ACCOUNT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AccountingPackage.Literals.REPORT_GROUP__REPORT_GROUP);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AccountingPackage.Literals.REPORT_GROUP__REPORT_GROUP,
